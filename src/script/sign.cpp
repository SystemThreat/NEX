                     ...
                     std::vector<valtype>& ret, TxoutType& whichTypeRet, SigVersion sigversion, SignatureData& sigdata)
{
    ...
    case TxoutType::WITNESS_V2_PQ:
        // PQ signing is handled by the iOS/external wallet, not the built-in signer.
        // The built-in wallet can recognize and display PQ outputs but cannot sign them
        // without the ML-DSA-65 private key (which lives on the user's device).
        return false;
