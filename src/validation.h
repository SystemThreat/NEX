...
public:
    ...
    //! NEX claim index — tracks BTC snapshot claims in LevelDB.
    //! Initialized during node startup. nullptr in tests that don't need it.
    std::unique_ptr<CClaimIndex> m_claim_index;
